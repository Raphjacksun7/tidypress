...
from tidypress.runtime import STREAM_COMMANDS, _is_python_wrapper_executable, resolve_runtime
...
async def run_cli_async(argv: Sequence[str]) -> int:
    ...
    if os.environ.get("TIDYPRESS_USE_NPX") == "1":
        ...
        process = await asyncio.create_subprocess_exec(npx, "tidypress", *argv)
