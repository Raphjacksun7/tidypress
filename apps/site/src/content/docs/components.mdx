...
All components work in `.mdx` files. They are pre-wired by the engine — no import statement needed in your content files. Collapsible sections use native HTML and also require no import.
